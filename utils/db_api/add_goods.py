...
async def add_items():
    await add_item(id=1, name='Футболка РДШ', price=500,
    ...
    await add_item(id=2, name='Поло РДШ', price=700,
                   ...
                   emodji='🥼',
                   category_name='Одежда', category_code='1clothes')
    await add_item(id=3, name='Значок РДШ', price=60,
    ...
    await add_item(id=5, name='Флаг РДШ (большой)', price=600,
                   ...
                   emodji='🏁',
                   category_name='Другое', category_code='3other')
    await add_item(id=6, name='Блокнот РДШ', price=55,
                   ...
                   emodji='📔',
                   category_name='Другое', category_code='3other')
    await add_item(id=7, name='Стенд информационный РДШ', price=1200,
    ...
    await add_item(id=8, name='Стенд обычный РДШ', price=700,
                   photos=['AgACAgIAAxkBAAIS21__OPC11O7duK-pr7SlK9H69Ps6AAK4sDEbJx4AAUjXCuadGlIuL_md6JcuAAMBAAMCAAN4AAMznwUAAR4E'], emodji='💼',
                   category_name='Стенды', category_code='2stands')
    await add_item(id=9, name='Стенд-паук РДШ', price=1500,
                   photos=['AgACAgIAAxkBAAIS21__OPC11O7duK-pr7SlK9H69Ps6AAK4sDEbJx4AAUjXCuadGlIuL_md6JcuAAMBAAMCAAN4AAMznwUAAR4E'], emodji='💼',
                   category_name='Стенды', category_code='2stands')
